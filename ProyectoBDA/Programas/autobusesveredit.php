...
<head>
    ...
    <title>Registros Tabla Autobus</title>
...
include('menusup.php');
include("mod_autoelim.php");
include("mod_autoadd.php");
include("mod_automdf.php");
?>
...
<script src="js/appautobuses.js"></script>
