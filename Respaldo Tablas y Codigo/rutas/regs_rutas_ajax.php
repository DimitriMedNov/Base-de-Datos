...
if($action == 'ajax'){
    ...
    $reload = 'rutasveredit.php'; /* Modificar aqui segun tu programa */

    //consulta principal para recuperar los datos
    $query = mysqli_query($con,"SELECT * FROM rutas  order by Rutas LIMIT $offset,$per_page");
    // echo $numrows ;
    // exit("pausado");
    if ($numrows>0){
        ?>
