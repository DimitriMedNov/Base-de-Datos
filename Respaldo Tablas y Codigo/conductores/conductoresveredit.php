...
include('menusup.php');
include("mod_conductoresadic.php");
include("mod_conductoreselim.php");
include("mod_conductoresmdf.php");
?>
<div class="container-fluid">	 <!-- se adapta al ancho del navegador -->
    <ol class="breadcrumb"> <!-- clase ruta - migajas de pan <ol>listas o viñetas ordenada-->
        <li><a href="#">Conductores del Mayabus</a></li>
...
<script src="js/app_conductores.js"></script>
